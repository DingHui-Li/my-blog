import { b as ElButton } from './el-overlay-5312b424.mjs';
import { a as ElTable, b as ElTableColumn, E as ElTag } from './el-tag-2a74a866.mjs';
import { c as comAddTopic, E as ElImage } from './addTopic-ae17e8de.mjs';
import { $ as $http, a1 as ElMessage } from '../server.mjs';
...
import './el-scrollbar-cbb29ac3.mjs';
import '@popperjs/core';
import 'escape-html';
import './el-popper-91356671.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "topic-list-page" }, _attrs))} data-v-b52972e0><div class="actions" data-v-b52972e0>`);
                ...
                default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    if (col.key == "createTime") {
                      _push3(`<span data-v-b52972e0${_scopeId2}>${ssrInterpolate(unref(moment)(row.createTime).format("YYYY-MM-DD HH:mm"))}</span>`);
                      ...
                      _push3(`<span data-v-b52972e0${_scopeId2}>${ssrInterpolate(row[col.key])}</span>`);
                    }
                  } else {
                    return [
...
const topic = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-b52972e0"]]);

export { topic as default };
//# sourceMappingURL=topic-503d2f8d.mjs.map
