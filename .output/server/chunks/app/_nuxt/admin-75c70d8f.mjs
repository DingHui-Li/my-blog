import { j as useNamespace, e as buildProps, h as iconPropType, g as definePropType, m as mutable, w as withInstall, q as withNoopInstall, _ as _export_sfc$1, D as throwError, a4 as arrow_down_default, S as arrow_right_default, E as ElIcon, an as more_default, u as useRouter, ao as menu_default, G as addClass, H as removeClass, F as hasClass } from '../server.mjs';
...
import { E as ElTooltip } from './el-popper-91356671.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "layout" }, _attrs))} data-v-c1182440><div class="topbar-container" data-v-c1182440>`);
      ...
      _push(`</div><div class="content-container" data-v-c1182440><div class="${ssrRenderClass([`${unref(showSideMenu) && "show"}`, "sidebar"])}" data-v-c1182440>`);
            ...
            ssrRenderList(menuList, (item) => {
              _push2(ssrRenderComponent(_component_el_menu_item, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<span data-v-c1182440${_scopeId2}>${ssrInterpolate(item.title)}</span>`);
                  } else {
                    return [
      ...
      _push(`</div><div class="content" data-v-c1182440>`);
...
const admin = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c1182440"]]);

export { admin as default };
//# sourceMappingURL=admin-75c70d8f.mjs.map
