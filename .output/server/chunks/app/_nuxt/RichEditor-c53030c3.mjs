import { useSSRContext, watch, mergeProps, unref, withCtx, createVNode, openBlock, createBlock, Fragment, renderList, toDisplayString, resolveComponent, withDirectives, vModelSelect } from 'vue';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(editor)) {
        _push(ssrRenderComponent(unref(BubbleMenu), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="item disabled" data-v-794edb2b${_scopeId}>&gt;</div><div class="${ssrRenderClass([{ "is-active": unref(editor).isActive("bold") }, "item"])}" data-v-794edb2b${_scopeId}>\u52A0\u7C97</div><div class="${ssrRenderClass([{ "is-active": unref(editor).isActive("italic") }, "item"])}" data-v-794edb2b${_scopeId}>\u659C\u4F53</div><div class="${ssrRenderClass([{ "is-active": unref(editor).isActive("strike") }, "item"])}" data-v-794edb2b${_scopeId}>\u5212\u7EBF</div><div class="${ssrRenderClass([{ "is-active": unref(editor).isActive("paragraph") }, "item"])}" data-v-794edb2b${_scopeId}>\u6BB5\u843D</div><div class="${ssrRenderClass([{ "is-active": unref(editor).isActive("highlight") }, "item"])}" data-v-794edb2b${_scopeId}>\u9AD8\u5149</div><div class="${ssrRenderClass([{ "is-active": unref(editor).isActive("link") }, "item"])}" data-v-794edb2b${_scopeId}>\u94FE\u63A5</div><div class="item"${ssrIncludeBooleanAttr(!unref(editor).isActive("link")) ? " disabled" : ""} data-v-794edb2b${_scopeId}>\u53D6\u6D88\u94FE\u63A5</div><!--[-->`);
              ssrRenderList(2, (item) => {
                _push2(`<div class="${ssrRenderClass([{ "is-active": unref(editor).isActive("heading", { level: item }) }, "item"])}" data-v-794edb2b${_scopeId}>H${ssrInterpolate(item)}</div>`);
              });
              _push2(`<!--]--><div data-v-794edb2b${_scopeId}></div><div class="item disabled" data-v-794edb2b${_scopeId}>&gt;</div><!--[-->`);
              ssrRenderList(aligns, (item) => {
                _push2(`<div class="${ssrRenderClass([{ "is-active": unref(editor).isActive({ textAlign: item.value }) }, "item"])}" data-v-794edb2b${_scopeId}>${ssrInterpolate(item.label)}</div>`);
              });
              _push2(`<!--]--><div data-v-794edb2b${_scopeId}></div><div class="item disabled" data-v-794edb2b${_scopeId}>&gt;</div><div class="${ssrRenderClass([{ "is-active": unref(editor).isActive("codeBlock") }, "item"])}" data-v-794edb2b${_scopeId}>\u4EE3\u7801\u5757</div><div class="${ssrRenderClass([{ "is-active": unref(editor).isActive("bulletList") }, "item"])}" data-v-794edb2b${_scopeId}>\u65E0\u5E8F\u5217\u8868</div><div class="${ssrRenderClass([{ "is-active": unref(editor).isActive("orderedList") }, "item"])}" data-v-794edb2b${_scopeId}>\u6709\u5E8F\u5217\u8868</div><div class="item" data-v-794edb2b${_scopeId}>\u5206\u9694\u7EBF</div><div class="item" data-v-794edb2b${_scopeId}>\u7A7A\u884C</div><div data-v-794edb2b${_scopeId}></div><div class="item disabled" data-v-794edb2b${_scopeId}>&gt;</div><div class="item"${ssrIncludeBooleanAttr(!unref(editor).can().chain().focus().undo().run()) ? " disabled" : ""} data-v-794edb2b${_scopeId}>undo \u2B05\uFE0F</div><div class="item"${ssrIncludeBooleanAttr(!unref(editor).can().chain().focus().redo().run()) ? " disabled" : ""} data-v-794edb2b${_scopeId}>redo \u27A1\uFE0F</div>`);
            } else {
              return [
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-794edb2b"]]);

export { __nuxt_component_0 as _ };
//# sourceMappingURL=RichEditor-c53030c3.mjs.map
