...
import { ssrRenderAttr, ssrInterpolate, ssrRenderList, ssrRenderClass, ssrRenderStyle, ssrRenderComponent, ssrRenderAttrs } from 'vue/server-renderer';
import { _ as _export_sfc } from './_plugin-vue_export-helper-cc2b3d55.mjs';
import { a as useSysStore, ab as useRoute, $ as $http } from '../server.mjs';
import comArticleItem from './articleItem-8d0aea2a.mjs';
import comMomentItem from './momentItem-06354a25.mjs';
import comAlbumItem from './albumItem-dee6ea0e.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(website).cover) {
        _push(`<div class="cover" data-v-97c0ddc5><div class="img-box" data-v-97c0ddc5><img${ssrRenderAttr("src", unref(website).cover)} data-v-97c0ddc5></div><div class="profile" data-v-97c0ddc5><div class="name" data-v-97c0ddc5>${ssrInterpolate(unref(profile).name)}</div><div class="avatar" data-v-97c0ddc5><img${ssrRenderAttr("src", unref(profile).avatar)} alt="" data-v-97c0ddc5></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="home" data-v-97c0ddc5><!--[-->`);
      ssrRenderList(unref(list), (item, index2) => {
        var _a2, _b, _c, _d, _e, _f, _g;
        _push(`<div class="${ssrRenderClass([unref(type), "item"])}" style="${ssrRenderStyle(`animation-delay:${index2 % 10 * 100}ms`)}" data-v-97c0ddc5>`);
        if (unref(type) == "photo") {
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-97c0ddc5"]]);

export { index as default };
//# sourceMappingURL=index-4ab662ea.mjs.map
