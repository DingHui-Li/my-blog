import { defineComponent, computed, watch, provide, reactive, toRefs, openBlock, createElementBlock, normalizeClass, unref, renderSlot, useSlots, inject, ref, createVNode, withCtx, createBlock, resolveDynamicComponent, normalizeStyle, createTextVNode, toDisplayString, createCommentVNode, createElementVNode, TransitionGroup, isRef, onScopeDispose, onUpdated, Fragment, nextTick, h } from 'vue';
import { computed as computed$1 } from '@vue/reactivity';
import { b as buildProps, L as componentSizes, d as definePropType, l as useNamespace, M as debugWarn, g as useId, j as addUnit, e as isBoolean, N as getProp, w as withInstall, O as withNoopInstall, H as throwError, I as hasClass, G as getStyle, J as addClass, _ as _export_sfc, K as removeClass } from '../server.mjs';
import { refDebounced, isClient, useResizeObserver } from '@vueuse/core';
import { f as formContextKey, a as formItemContextKey } from './focus-trap-53f8dfef.mjs';
import { isString, NOOP, isArray, isFunction } from '@vue/shared';
import { castArray, clone } from 'lodash-unified';
import { a as useFormSize } from './el-message-box-a46c6096.mjs';
...
export { ElForm as E, ElFormItem as a, ElOverlay as b, useSameTarget as c, getScrollContainer as g, scrollIntoView as s, useLockscreen as u };
//# sourceMappingURL=el-form-item-9758f43f.mjs.map
