import { useSSRContext, defineComponent, computed, ref, watch, unref, mergeProps } from 'vue';
...
import { s as storeToRefs, a as useSysStore, ac as useRoute, $ as $http } from '../server.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(website).cover) {
        _push(`<div class="cover" data-v-ba9d3170><div class="img-box" data-v-ba9d3170><img${ssrRenderAttr("src", unref(website).cover)} data-v-ba9d3170></div><div class="profile" data-v-ba9d3170><div class="name" data-v-ba9d3170>${ssrInterpolate(unref(profile).name)}</div><div class="avatar" data-v-ba9d3170><img${ssrRenderAttr("src", unref(profile).avatar)} alt="" data-v-ba9d3170></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="home" data-v-ba9d3170><!--[-->`);
      ssrRenderList(unref(list), (item, index2) => {
        var _a2, _b, _c, _d, _e, _f, _g;
        _push(`<div class="${ssrRenderClass([unref(type), "item"])}" style="${ssrRenderStyle(`animation-delay:${index2 % 10 * 100}ms`)}" data-v-ba9d3170>`);
        if (unref(type) == "photo") {
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ba9d3170"]]);

export { index as default };
//# sourceMappingURL=index-f4b514b6.mjs.map
