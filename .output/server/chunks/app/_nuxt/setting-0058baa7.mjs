import { u as useFormItem, a as useFormSize, E as ElInput, b as ElButton } from './el-overlay-5312b424.mjs';
import { e as buildProps, g as definePropType, l as circle_close_default, f as useSizeProp, I as useLocale, j as useNamespace, d as debugWarn, ah as clock_default, ai as calendar_default, E as ElIcon, a5 as d_arrow_left_default, a7 as d_arrow_right_default, ag as isEmpty, t as EVENT_CODE, _ as _export_sfc$1, u as useRouter, a as useSysStore, $ as $http, a0 as picture_filled_default, F as hasClass, a1 as ElMessage, R as arrow_left_default, S as arrow_right_default, A as isUndefined, C as getStyle, a8 as arrow_up_default, a4 as arrow_down_default } from '../server.mjs';
...
import { E as ElTooltip, T as TOOLTIP_INJECTION_KEY } from './el-popper-91356671.mjs';
import { C as ClickOutside, E as ElScrollbar } from './el-scrollbar-cbb29ac3.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "setting-page" }, _attrs))} data-v-ed0bc990><div class="title" data-v-ed0bc990>\u7F51\u7AD9\u8BBE\u7F6E</div><div class="form-item" data-v-ed0bc990><div class="label" data-v-ed0bc990>\u540D\u79F0</div><div class="value" data-v-ed0bc990>`);
      _push(ssrRenderComponent(_component_el_input, {
        modelValue: unref(form).website.name,
        "onUpdate:modelValue": ($event) => unref(form).website.name = $event
      }, null, _parent));
      _push(`</div></div><div class="form-item" data-v-ed0bc990><div class="label" data-v-ed0bc990>\u5C01\u9762\u56FE\u7247</div><div class="value" data-v-ed0bc990><div class="img" data-v-ed0bc990>`);
      if (!unref(form).website.cover) {
        ...
        _push(`<img${ssrRenderAttr("src", unref(form).website.cover)} data-v-ed0bc990>`);
      }
      _push(`<input type="file" accept="image/*" data-v-ed0bc990></div></div></div><div class="form-item" data-v-ed0bc990><div class="label" data-v-ed0bc990>\u300A\u5173\u4E8E\u6211\u300B</div><div class="value" data-v-ed0bc990>`);
      _push(ssrRenderComponent(_component_el_input, {
      ...
      if (unref(aboutmeArticle)._id) {
        _push(`<div class="article" data-v-ed0bc990><div class="title" data-v-ed0bc990>\u300A${ssrInterpolate(unref(aboutmeArticle).title)}\u300B</div><div class="time" data-v-ed0bc990>${ssrInterpolate(unref(moment)(unref(aboutmeArticle).updateTime).calendar())}\u66F4\u65B0</div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div><div class="form-item" data-v-ed0bc990><div class="label" data-v-ed0bc990>\u300A\u5173\u4E8E\u672C\u7AD9\u300B</div><div class="value" data-v-ed0bc990>`);
      _push(ssrRenderComponent(_component_el_input, {
      ...
      if (unref(aboutArticle)._id) {
        _push(`<div class="article" data-v-ed0bc990><div class="title" data-v-ed0bc990>\u300A${ssrInterpolate(unref(aboutArticle).title)}\u300B</div><div class="time" data-v-ed0bc990>${ssrInterpolate(unref(moment)(unref(aboutArticle).updateTime).calendar())}\u66F4\u65B0</div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div><div class="title" data-v-ed0bc990>\u4E2A\u4EBA\u4FE1\u606F</div><div class="form-item" data-v-ed0bc990><div class="label" data-v-ed0bc990>\u6635\u79F0</div><div class="value" data-v-ed0bc990>`);
      _push(ssrRenderComponent(_component_el_input, {
        modelValue: unref(form).profile.name,
        "onUpdate:modelValue": ($event) => unref(form).profile.name = $event
      }, null, _parent));
      _push(`</div></div><div class="form-item" data-v-ed0bc990><div class="label" data-v-ed0bc990>\u5934\u50CF</div><div class="value" data-v-ed0bc990><div class="img" data-v-ed0bc990>`);
      if (!unref(form).profile.avatar) {
        ...
        _push(`<img${ssrRenderAttr("src", unref(form).profile.avatar)} data-v-ed0bc990>`);
      }
      _push(`<input type="file" accept="image/*" data-v-ed0bc990></div></div></div><div class="form-item" data-v-ed0bc990><div class="label" data-v-ed0bc990>\u751F\u65E5</div><div class="value" data-v-ed0bc990>`);
      ...
      _push(`</div></div><div class="actions" data-v-ed0bc990>`);
...
const setting = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ed0bc990"]]);

export { setting as default };
//# sourceMappingURL=setting-0058baa7.mjs.map
