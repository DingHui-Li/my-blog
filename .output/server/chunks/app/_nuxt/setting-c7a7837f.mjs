import { u as useFormItem, a as useFormSize, E as ElInput, b as ElButton } from './el-message-box-a46c6096.mjs';
import { b as buildProps, d as definePropType, T as circle_close_default, Q as useSizeProp, a as useLocale, l as useNamespace, M as debugWarn, ae as clock_default, af as calendar_default, E as ElIcon, a0 as d_arrow_left_default, a2 as d_arrow_right_default, ad as isEmpty, W as EVENT_CODE, _ as _export_sfc$1, ag as useSysStore, D as picture_filled_default, I as hasClass, $ as $http, F as ElMessage, r as arrow_left_default, t as arrow_right_default, Y as isUndefined, G as getStyle, a3 as arrow_up_default, Z as arrow_down_default } from '../server.mjs';
...
import { E as ElTooltip, T as TOOLTIP_INJECTION_KEY } from './el-popper-877b471b.mjs';
import { C as ClickOutside, E as ElScrollbar } from './el-scrollbar-a3241661.mjs';
import { onClickOutside } from '@vueuse/core';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderAttr } from 'vue/server-renderer';
import { _ as _export_sfc } from './_plugin-vue_export-helper-cc2b3d55.mjs';
import './focus-trap-53f8dfef.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "setting-page" }, _attrs))} data-v-a563daf9><div class="title" data-v-a563daf9>\u7F51\u7AD9\u8BBE\u7F6E</div><div class="form-item" data-v-a563daf9><div class="label" data-v-a563daf9>\u540D\u79F0</div><div class="value" data-v-a563daf9>`);
      _push(ssrRenderComponent(_component_el_input, {
        modelValue: unref(form).website.name,
        "onUpdate:modelValue": ($event) => unref(form).website.name = $event
      }, null, _parent));
      _push(`</div></div><div class="form-item" data-v-a563daf9><div class="label" data-v-a563daf9>\u5C01\u9762\u56FE\u7247</div><div class="value" data-v-a563daf9><div class="img" data-v-a563daf9>`);
      if (!unref(form).website.cover) {
        ...
        _push(`<img${ssrRenderAttr("src", unref(form).website.cover)} data-v-a563daf9>`);
      }
      _push(`<input type="file" accept="image/*" data-v-a563daf9></div></div></div><div class="title" data-v-a563daf9>\u4E2A\u4EBA\u4FE1\u606F</div><div class="form-item" data-v-a563daf9><div class="label" data-v-a563daf9>\u6635\u79F0</div><div class="value" data-v-a563daf9>`);
      _push(ssrRenderComponent(_component_el_input, {
        modelValue: unref(form).profile.name,
        "onUpdate:modelValue": ($event) => unref(form).profile.name = $event
      }, null, _parent));
      _push(`</div></div><div class="form-item" data-v-a563daf9><div class="label" data-v-a563daf9>\u5934\u50CF</div><div class="value" data-v-a563daf9><div class="img" data-v-a563daf9>`);
      if (!unref(form).profile.avatar) {
        ...
        _push(`<img${ssrRenderAttr("src", unref(form).profile.avatar)} data-v-a563daf9>`);
      }
      _push(`<input type="file" accept="image/*" data-v-a563daf9></div></div></div><div class="form-item" data-v-a563daf9><div class="label" data-v-a563daf9>\u751F\u65E5</div><div class="value" data-v-a563daf9>`);
      ...
      _push(`</div></div><div class="actions" data-v-a563daf9>`);
...
const setting = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a563daf9"]]);

export { setting as default };
//# sourceMappingURL=setting-c7a7837f.mjs.map
